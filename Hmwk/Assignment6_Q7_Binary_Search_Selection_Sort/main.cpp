...
void sort(int array[], const int SIZE)                                  //Selection Sort function
{
    int scan, minI, minV;                                               //Scan, minimum input, minimum value
    for (scan=0; scan<(SIZE-1); scan++)                                 //Scan loop
    {
        minI=scan;                                                      
        minV=array[scan];                                               
        for (int index=scan+1; index<SIZE; index++)                     //Sort loop
        {
            if (array[index]<minV)                                      //Sets value if lower then previous
            {
                minV=array[index];
                minI=index;
            }
